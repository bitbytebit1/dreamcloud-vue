  ...
  methods: {
    download () {
      ...
      for (const link in this.links) {
        window.open('http://dreamcloud.mynetgear.com:7000/api/v3/stream?t=' + encodeURIComponent(this.links[link].title) + '&i=' + encodeURIComponent(this.links[link].mp32), '_blank')

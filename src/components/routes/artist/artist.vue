<template>
  <v-flex xs12 lg10 xl10 flexbox>
    ...
    <infinite-loading :distance="420" ref="infiniteLoading" v-if="!loading" @infinite="infiniteHandler" spinner="default">
      <span slot="no-more"></span>
      <span slot="spinner">*_*</span>
    </infinite-loading>
...
export default {
  ...
  methods: {
    ...
    search: function (artistID, source, iPage = 0, state = 0) {

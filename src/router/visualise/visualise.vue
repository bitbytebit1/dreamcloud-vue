...
export default {
  ...
  mounted () {  
    ...
    function Visualization(config) {
      ...
      var init = function() {
        audio = document.getElementById('dc-audio');
...
<style scoped>
	body { font-family:'Open Sans', serif; font-size:100%;}
		...
		.circularBar { position:absolute; width:10px; border-bottom-left-radius:10px; border-bottom-right-radius:10px; min-height:5px; background:black; -webkit-transition:0.1s ease all; border-bottom:3px solid rgb(0,255,0); }
		.curveBar { position:absolute; width:10px; height:5px; background:black; border-radius:5px; min-height:5px; border-bottom:3px solid rgb(0,255,0); border-top:3px solid rgb(255,0,0); -webkit-transition:0.1s ease all; }
		#circularCenter { margin: auto; position: absolute; top: 0; left: 0; bottom: 0; right: 0; width:74px; height:74px; border-radius:100%; background:rgb(255,0,0); }
		...
		.bar { position:absolute; bottom:0; box-shadow:0px -2px 0 rgb(0,255,0); background:black; -webkit-transition:0.1s ease all;}
		.dot { position:absolute; bottom:0; background:black; box-shadow:0 0 1px 1px rgb(0,255,0); -webkit-transition:0.1s ease all; height:5px; }
		.symbar_left { position:absolute; right:180px; background:black; -webkit-transition:0.1s ease all; border-bottom-left-radius: 15px; border-top-left-radius:15px; border-left:5px solid rgb(0,255,0);}
		.symbar_right { position:absolute; left:180px; background:black; -webkit-transition:0.1s ease all; border-bottom-right-radius:15px; border-top-right-radius:15px; border-right:3px solid rgb(255,0,0);}
		.initiator {
			position:absolute;
			width:360px; height:360px; 
